...
class TokenizedDataset(IterableDataset):
    ...
    def __init__(
        ...
        num_shots=None,# @edited: vashisth
        task_name=None# @edited: vashisth
    ):
        self.task = task
        ...
        self.num_shots = num_shots #  @edited: vashisth
        self.task_name = task_name  # @edited: vashisth
    ...
    def __iter__(self):
        ...
        for sample in range(self.limit_start, self.limit_start + self.n_tasks):
            ...
            if self.num_shots is not None:
                prompt_contents = self.task.get_prompt_with_fewshots(self.dataset[sample], self.num_shots)
            else: 
